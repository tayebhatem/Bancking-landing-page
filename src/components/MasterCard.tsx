...
const MasterCard = () => {
  return (
    <div className='w-[220px] h-[150px] lg:w-[290px] lg:h-[190px] p-5 hidden md:flex flex-col justify-between bg-[#0E0A5F]/60 backdrop-blur-sm rounded-2xl absolute top-1/3 left-1/2'>
